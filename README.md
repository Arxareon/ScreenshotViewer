# <img src="https://wago-addons.ams3.digitaloceanspaces.com/thumbnails/.png" alt="Screenshot Viewer Logo" width="40" height="40" align="top"> Screenshot Viewer
...
***A simple solution to a simple problem:*** Screenshot Viewer shows your screenshots.

### Features
- Set up Screenshot Viewer in the Interface Options, access select options via the **/scrvr** chat command.

### Support

Alongside the one-time & monthly donation options featured above, watching ads on [**CurseForge**](https://www.curseforge.com/wow/addons/movement-speed) or [**Wago**](https://addons.wago.io/addons/movement-speed) also supports my work. You can keep up to date via the CurseForge or Wago App *as well as **[WoWUP](https://wowup.io/)** if you enable CurseForge or Wago.io as an addon provider*.
...
Screenshot Viewer was built with [Widget Tools](https://github.com/Arxareon/WidgetTools).

## License
All Rights Reserved.

- - -
Thank you for checking out Screenshot Viewer!
